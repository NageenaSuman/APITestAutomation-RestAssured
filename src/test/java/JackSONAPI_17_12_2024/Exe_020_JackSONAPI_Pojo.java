package JackSONAPI_17_12_2024;

import JackSONAPI_17_12_2024.Booking;
import JackSONAPI_17_12_2024.Bookingdates;
import JackSONAPI_17_12_2024.ResponseBooking;
...
public class Exe_020_JackSONAPI_Pojo {
    RequestSpecification r = RestAssured.given();
    Response re;
    ValidatableResponse vr;

    @Test
    public void test_Booking() throws JsonProcessingException {
...
//        System.out.println(booking);
        ...
        String payload;
        payload = objmap.writerWithDefaultPrettyPrinter().writeValueAsString(booking);
        ...
        ResponseBooking rp = objmap.readValue(json_string, ResponseBooking.class);
        ...
        assertThat(rp.getBooking().getFirstname()).isEqualTo("Hash Bash Tash").isNotNull().isNotEmpty();
